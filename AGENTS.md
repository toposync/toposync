...
- Para subir o ambiente local para testes/validação visual, use `TOPOSYNC_AUTH_MODE=bypass npm run dev`. Evite `npm run dev` sem bypass para esse fluxo, porque a UI entra no fluxo de autenticação e chamadas locais podem retornar 401.
