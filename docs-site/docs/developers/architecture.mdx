---
title: Architecture
description: "Understand the current Toposync architecture: Python backend, React frontend, extensions, pipelines, and processing servers."
keywords: ["toposync", "local-first", "home automation", "architecture", "developers", "extensions"]
