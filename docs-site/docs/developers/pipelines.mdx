---
title: Pipelines
description: "Learn how Toposync pipelines work, including operator graphs, local execution, remote processing, and extension contracts."
keywords: ["toposync", "local-first", "home automation", "pipelines", "operators", "processing server"]
...
For product events, the canonical identity is `payload.subject`. Camera and
vision event packets should set:
