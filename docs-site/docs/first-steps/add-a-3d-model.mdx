...
description: "Add a lightweight 3D model to a Toposync composition and understand supported formats and performance expectations."
keywords: ["toposync", "local-first", "home automation", "first steps", "3D model", "composition"]
