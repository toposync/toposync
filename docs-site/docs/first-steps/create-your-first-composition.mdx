...
description: "Create your first Toposync composition using a tracing image, walls, areas, cameras, and lightweight spatial context."
keywords: ["toposync", "local-first", "home automation", "first steps", "composition", "floor plan"]
