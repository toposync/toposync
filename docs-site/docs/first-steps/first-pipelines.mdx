...
description: "Create your first Toposync pipelines from camera events to simple automation outputs and notifications."
keywords: ["toposync", "local-first", "home automation", "first steps", "pipelines", "automation"]
...
| Mapped individual people events | Required | You want one event per tracked person, with spatial context. |
| Mapped grouped presence | Required | You want fewer notifications during one continuous activity session. |
