---
title: Python and uv
description: "Use uv with Python to install, update, and manage Toposync environments for local self-hosting."
keywords: ["toposync", "local-first", "home automation", "Python", "uv", "installation"]
