...
description: "Reference Toposync environment variables for auth, data directories, Home Assistant, streaming, and processing servers."
keywords: ["toposync", "local-first", "home automation", "environment variables", "configuration", "reference"]
