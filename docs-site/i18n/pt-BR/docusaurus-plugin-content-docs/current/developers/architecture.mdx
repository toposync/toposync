...
- PTZ Attention: arbitragem sensível ao ciclo de vida que seleciona eventos semânticos relevantes, focaliza presets PTZ calibrados permitidos e coordena o retorno.
...
A extensão Cameras é dona da atuação PTZ física, leases, proteção contra comandos antigos e tomada de controle manual. PTZ Attention é dona da seleção semântica, sessões de foco, tempos e política de retorno. Essa divisão mantém o controle de dispositivos genérico e permite evoluir o comportamento de atenção por evento de forma independente.
