---
title: Arquitetura
description: "Entenda a arquitetura atual do Toposync: backend Python, frontend React, extensões, pipelines e processing servers."
keywords: ["toposync", "local-first", "automação residencial", "arquitetura", "desenvolvedores", "extensões"]
