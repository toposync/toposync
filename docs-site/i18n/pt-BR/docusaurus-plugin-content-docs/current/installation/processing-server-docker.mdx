...
```text
ghcr.io/toposync/toposync:0.7.8-cuda
```
...
```bash
docker pull ghcr.io/toposync/toposync:0.7.8
```

Para CUDA:

```bash
docker pull ghcr.io/toposync/toposync:0.7.8-cuda
```
...
Para CUDA, troque a imagem para `ghcr.io/toposync/toposync:0.7.8-cuda` e
