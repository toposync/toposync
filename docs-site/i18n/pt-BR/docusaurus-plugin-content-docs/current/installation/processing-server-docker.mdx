...
```text
ghcr.io/toposync/toposync:0.7.10-cuda
```
...
```bash
docker pull ghcr.io/toposync/toposync:0.7.10
```

Para CUDA:

```bash
docker pull ghcr.io/toposync/toposync:0.7.10-cuda
```
...
Para CUDA, troque a imagem para `ghcr.io/toposync/toposync:0.7.10-cuda` e
