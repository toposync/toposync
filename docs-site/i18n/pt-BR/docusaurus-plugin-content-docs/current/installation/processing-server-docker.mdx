...
```bash
docker pull ghcr.io/toposync/toposync:0.7.9
```

Para CUDA:

```bash
docker pull ghcr.io/toposync/toposync:0.7.9-cuda
```
...
Para CUDA, troque a imagem para `ghcr.io/toposync/toposync:0.7.9-cuda` e
