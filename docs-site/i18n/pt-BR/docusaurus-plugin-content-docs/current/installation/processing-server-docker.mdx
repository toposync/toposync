...
```text
ghcr.io/toposync/toposync:0.7.7-cuda
```
...
```bash
docker pull ghcr.io/toposync/toposync:0.7.7
```

Para CUDA:

```bash
docker pull ghcr.io/toposync/toposync:0.7.7-cuda
```
...
Para CUDA, troque a imagem para `ghcr.io/toposync/toposync:0.7.7-cuda` e
