---
title: Processing Server Em Linux/macOS
description: "Rode um processing server Toposync em Linux ou macOS com uv, Basic Auth e upgrades CUDA opcionais em Linux."
keywords: ["toposync", "local-first", "automação residencial", "processing server", "Linux", "macOS"]
image: /img/social-card.png
sidebar_position: 10
---

# Processing Server Em Linux/macOS {/* #processing-server-linux-macos */}
...
Para suporte por sistema, arquitetura e GPU, consulte [Compatibilidade](architecture-support.mdx).
...
Se precisar reproduzir uma versão publicada específica, troque `X.Y.Z` pela versão desejada:
