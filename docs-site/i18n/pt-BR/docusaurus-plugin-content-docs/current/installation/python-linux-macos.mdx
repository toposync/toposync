---
title: Python em Linux/macOS
description: "Instale o Toposync diretamente com Python e uv em Linux ou macOS, inicie o servidor local e verifique a API."
keywords: ["toposync", "local-first", "automação residencial", "Python", "uv", "Linux", "macOS"]
image: /img/social-card.png
sidebar_position: 6
---

# Python em Linux/macOS {/* #python-linux-macos */}
