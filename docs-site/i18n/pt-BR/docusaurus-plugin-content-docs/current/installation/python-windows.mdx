---
title: Python em Windows
description: "Instale o Toposync no Windows com Python 3.12, uv, upgrades opcionais DirectML ou CUDA e troubleshooting."
keywords: ["toposync", "local-first", "automação residencial", "Python", "Windows", "DirectML", "CUDA"]
image: /img/social-card.png
sidebar_position: 7
---

# Python em Windows {/* #python-windows */}
