...
description: "Referência de variáveis de ambiente do Toposync para auth, diretórios de dados, Home Assistant, streaming e processing servers."
keywords: ["toposync", "local-first", "automação residencial", "variáveis de ambiente", "configuração", "referência"]
