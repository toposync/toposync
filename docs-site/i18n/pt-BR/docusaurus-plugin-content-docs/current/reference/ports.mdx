---
title: Portas
description: "Referência de portas de rede do Toposync para UI web, APIs, add-on Home Assistant, streaming e processing servers."
keywords: ["toposync", "local-first", "automação residencial", "portas", "rede", "referência"]
