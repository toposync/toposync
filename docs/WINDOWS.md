...
```powershell
uv pip install --upgrade --refresh toposync==0.5.2
```
...
```powershell
uv pip install --upgrade --refresh toposync-vision-directml==0.5.2
```
...
```powershell
uv pip install --upgrade --refresh toposync-vision-cuda==0.5.2
```
