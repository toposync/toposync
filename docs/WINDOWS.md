...
```powershell
uv pip install --upgrade --refresh toposync==0.4.25
```
...
```powershell
uv pip install --upgrade --refresh toposync-vision-directml==0.4.25
```
...
```powershell
uv pip install --upgrade --refresh toposync-vision-cuda==0.4.25
```
