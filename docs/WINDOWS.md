...
```powershell
uv pip install --upgrade --refresh toposync-vision-directml==0.7.2
```
...
```powershell
uv pip install --upgrade --refresh toposync-vision-cuda==0.7.2
```
...
```powershell
uv pip install --upgrade --refresh toposync-streaming==0.7.2
```
