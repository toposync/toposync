...
function FixturePlayer(props:LiveViewPlayerProps){
 ...
 usePresentedFrame(video,active,props.sourceId??'',value=>props.onFrame?.(value?{...value,cameraId:props.cameraId,sourceId:props.sourceId,opticalSourceSize:photograph??{width:640,height:360},contentRect:{x:0,y:0,width:1,height:1}}:null));
 useEffect(()=>{
  if(!active)return;
 ...
 return <video data-source={props.sourceId} data-active={active} ref={video} muted playsInline style={{width:'100%',height:'100%'}}/>;
}
