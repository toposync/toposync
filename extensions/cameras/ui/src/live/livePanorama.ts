/** A completed operation owns its final epoch; later epochs remain external. */
export function isExternalMotionEpoch(previous: number | null, next: unknown, completed: number | null): boolean {
  return typeof next === 'number' && previous !== null && next !== previous && next !== completed;
}
...
.livePanoramaStop { margin-left: 4px; }
...
.livePanoramaFloatingBody { background: #000; isolation: isolate; }
.livePanoramaResizeHandle { position: absolute; z-index: 1; right: 0; bottom: 0; width: 34px; height: 34px; cursor: nwse-resize; touch-action: none; }
