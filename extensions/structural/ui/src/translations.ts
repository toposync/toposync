export const structuralTranslations = {
  en: {
    ...
    "ext.structural.editor.opening_center_hint": "Along the wall: {{start}} m = start, {{end}} m = end.",
  ...
  "pt-BR": {
    ...
    "ext.structural.editor.opening_center_hint": "Ao longo da parede: {{start}} m = início, {{end}} m = fim.",
