...
export const PIPELINE_OPERATOR_UX = {
  ...
  "vision.synthetic_detection_source": { group: "input", level: "advanced", order: 925 },
  ...
  "vision.spatial_relation_event": { group: "vision", level: "advanced", order: 40 },
  "vision.classify_image": { group: "vision", level: "advanced", order: 50 },
  "vision.segment_instances": { group: "vision", level: "basic", order: 60 },
  "vision.crop_objects": { group: "vision", level: "basic", order: 70 },
  "ai.condition_filter": { group: "vision", level: "basic", order: 80 },
  "ai.smart_crop": { group: "vision", level: "basic", order: 90 },
  "vision.pose_estimate": { group: "vision", level: "advanced", order: 100 },
...
export const OPERATOR_FRIENDLY_NAMES: Record<string, string> = {
  ...
  "stream.demand_gate": "Demand gate",
  "camera.source": "Use camera",
  "cinematic.director_source": "Cinematic director",
  "vision.synthetic_detection_source": "Synthetic detection source",
  ...
  "vision.spatial_relation_event": "Confirm nearby objects",
