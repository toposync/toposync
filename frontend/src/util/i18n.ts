...
const translationsByLocale: Record<Locale, Translations> = {
  en: {
    ...
    "core.ui.vision.huggingface_modal.intro_detection":
      "Probe a public Hugging Face repo, confirm that it already ships an ONNX file, then inspect and save it into this machine catalog.",
  ...
  "pt-BR": {
    ...
    "core.ui.vision.huggingface_modal.intro_detection":
      "Inspecione um repositório público do Hugging Face, confirme que ele já traz um arquivo ONNX e então inspecione e salve isso no catálogo desta máquina.",
    "core.ui.vision.huggingface_modal.intro_classification":
      "Inspecione um repositório público do Hugging Face, confirme que ele já traz um arquivo ONNX e então inspecione e salve isso no catálogo desta máquina.",
