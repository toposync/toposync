...
const translationsByLocale: Record<Locale, Translations> = {
  en: {
    ...
    "core.ui.pipelines.operator_name.ai.condition_filter": "Filter by visual condition",
  ...
  "pt-BR": {
    ...
    "core.ui.pipelines.operator_name.ai.condition_filter": "Filtrar por condição visual",
