...
const translationsByLocale: Record<Locale, Translations> = {
  en: {
    ...
    "core.ui.notifications.live": "Live",
    "core.ui.notifications.group_presence.description": "Presence in progress{{camera_suffix}}",
    "core.ui.notifications.group_presence.closed_description": "Presence ended{{camera_suffix}}",
    ...
    "core.ui.notifications.details.meta.observed_duration": "Duration through last update",
    "core.ui.notifications.details.meta.clock_changed": "Time reference changed; duration unavailable",
    "core.ui.notifications.details.meta.invalid_interval": "Invalid time interval; duration unavailable",
    ...
    "core.ui.settings.sections.compositions": "Compositions",
    "core.ui.settings.sections.compositions_desc": "Create, select and edit compositions.",
    ...
    "core.ui.settings.sidebar.main": "Main",
    "core.ui.settings.sidebar.system": "System",
    "core.ui.settings.sidebar.admin": "Admin",
    ...
    "core.ui.settings.confirm_open_composition_editor_title": "Discard changes and open the composition editor?",
    ...
    "core.ui.settings.compositions.create": "Create",
    "core.ui.settings.compositions.list_desc": "{{count}} composition(s) available.",
    "core.ui.settings.compositions.active": "Active",
    "core.ui.settings.compositions.available": "Available",
    "core.ui.settings.compositions.open_editor": "Open editor",
    "core.ui.settings.compositions.empty": "No compositions found.",
    "core.ui.settings.compositions.aria.active": "{{name}} is the active composition",
    "core.ui.settings.compositions.aria.select": "Select composition {{name}}",
    "core.ui.settings.compositions.aria.open_editor": "Open editor for {{name}}",
    "core.ui.settings.compositions.error.open_editor": "Failed to open composition editor",
    "core.ui.settings.extensions.loading": "Loading extensions…",
    "core.ui.settings.extensions.search_placeholder": "Search extensions…",
    "core.ui.settings.extensions.manual_label": "Package, GitHub URL, or local path",
    "core.ui.settings.extensions.manual_placeholder": "toposync-ext-example, https://github.com/org/toposync-ext-example, or /path/to/toposync-ext-example",
    "core.ui.settings.extensions.manual_hint": "PyPI packages must start with toposync-ext-. Local paths install editable by default.",
    "core.ui.settings.extensions.trust_title": "Extensions run local code",
    "core.ui.settings.extensions.trust_desc": "Only install extensions from authors and repositories you trust.",
    "core.ui.settings.extensions.browser_activation_failed": "Browser activation failed: {{error}}",
    ...
    "core.ui.settings.extensions.editable": "editable",
    ...
    "core.ui.settings.extensions.source_kind.pypi": "PyPI",
    "core.ui.settings.extensions.source_kind.github": "GitHub",
    "core.ui.settings.extensions.source_kind.git": "Git",
    "core.ui.settings.extensions.source_kind.local": "local path",
    ...
    "core.ui.render_modal.option_3d.desc": "Explore the space in a three-dimensional scene.",
    "core.ui.render_modal.option_2d.title": "2D (Image)",
    ...
    "core.ui.streams.variant.select": "Live camera variant",
    "core.ui.streams.variant.set_default": "Set as default for this use",
    "core.ui.streams.variant.auto": "Auto",
    "core.ui.streams.variant.low": "Low",
    "core.ui.streams.variant.stable": "Stable",
    "core.ui.streams.variant.high": "High",
    "core.ui.streams.variant.zoom": "Zoom",
    "core.ui.streams.variant.low_latency": "Low latency",
    "core.ui.streams.variant.custom": "Custom",
    "core.ui.streams.context.thumbnail": "Thumbnail",
    "core.ui.streams.context.pip": "PiP",
    "core.ui.streams.context.large": "Large",
    "core.ui.streams.context.fullscreen": "Fullscreen",
    "core.ui.streams.context.ptz": "PTZ",
    ...
    "core.ui.streams.advanced.state": "State",
    "core.ui.streams.advanced.state_label": "State",
    "core.ui.streams.advanced.state_message": "Message",
    "core.ui.streams.advanced.state_action": "Recommended action",
    "core.ui.streams.advanced.technical_status": "Technical status",
    "core.ui.streams.advanced.playback": "Playback",
    "core.ui.streams.advanced.player_status": "Player status",
    "core.ui.streams.advanced.active_transport": "Active transport",
    "core.ui.streams.advanced.effective_mode": "Effective mode",
    "core.ui.streams.advanced.transport_preference": "Transport preference",
    "core.ui.streams.advanced.quality_preference": "Quality preference",
    "core.ui.streams.advanced.low_latency_requested": "Low latency requested",
    "core.ui.streams.advanced.hls_fallback": "HLS fallback",
    "core.ui.streams.advanced.hls_public_base_path": "HLS public base path",
    "core.ui.streams.advanced.hls_ingress_prefix": "HLS ingress prefix in URL",
    "core.ui.streams.advanced.hls_media_origin": "HLS media origin",
    "core.ui.streams.advanced.last_hls_probe": "Last HLS probe",
    "core.ui.streams.advanced.hls_health": "HLS health",
    "core.ui.streams.advanced.webrtc_contract": "WebRTC contract",
    "core.ui.streams.advanced.player_error": "Player error",
    "core.ui.streams.advanced.current_hint": "Current hint",
    "core.ui.streams.advanced.selected_output": "Selected output",
    "core.ui.streams.advanced.runtime": "Technical diagnostics",
    "core.ui.streams.advanced.runtime_status": "Runtime status",
    "core.ui.streams.advanced.classification": "Classification",
    "core.ui.streams.advanced.selected_frame_age": "Selected frame age",
    "core.ui.streams.advanced.last_incoming_age": "Last incoming age",
    "core.ui.streams.advanced.last_live_frame": "Last live frame",
    "core.ui.streams.advanced.fallback_active": "Fallback active",
    "core.ui.streams.advanced.fallback_reason": "Fallback reason",
    "core.ui.streams.advanced.placeholder_active": "Placeholder active",
    "core.ui.streams.advanced.active_writer": "Active writer",
    "core.ui.streams.advanced.selected_writer": "Selected writer",
    "core.ui.streams.advanced.stream_behavior": "Stream behavior",
    "core.ui.streams.advanced.active_sessions": "Active sessions",
    ...
    "core.ui.streams.summary.working": "Working",
    "core.ui.streams.summary.warming": "Warming, wait",
    "core.ui.streams.summary.action_required": "Action needed",
    "core.ui.streams.summary.unknown": "No reading",
    "core.ui.streams.summary.message.working": "Working.",
    "core.ui.streams.summary.message.waiting_demand": "Warming when a viewer is present.",
    "core.ui.streams.summary.message.waiting_event": "Warming, waiting for an event.",
    "core.ui.streams.summary.message.warming_playback": "Warming playback, wait a few seconds.",
    "core.ui.streams.summary.message.recovering_fallback": "Warming with a fallback frame.",
    "core.ui.streams.summary.message.waiting_first_frame": "Warming, waiting for the first frame.",
    "core.ui.streams.summary.message.warming": "Warming, wait.",
    "core.ui.streams.summary.message.action_required": "Action needed.",
    ...
    "core.ui.streams.health.demand_idle": "Waiting for a viewer to start capture.",
    "core.ui.streams.health.demand_idle_label": "Waiting viewer",
    ...
    "core.ui.pipelines.status.read_only": "read-only",
    "core.ui.pipelines.generated.separator": "Generated pipelines",
    "core.ui.pipelines.generated.show": "Show generated pipelines",
    "core.ui.pipelines.generated.hide": "Hide generated pipelines",
    "core.ui.pipelines.read_only.badge": "Read-only",
    "core.ui.pipelines.read_only.message": "This generated pipeline is managed by its source and can only be inspected here.",
    "core.ui.pipelines.read_only.error": "Generated pipelines are read-only here.",
    ...
    "core.ui.pipelines.telemetry.metric.onvif_gate_open": "ONVIF condition",
    ...
    "core.ui.pipelines.alerts.notify_thumbnail_not_stored.message": "Send notification prefers artifact '{{input_artifact_name}}', but upstream Save images stores {{stored_artifacts}}; it will fall back to another stored image.",
    "core.ui.pipelines.alerts.notify_thumbnail_not_stored.suggestion": "Store the same artifact only when the notification must use that exact image.",
    ...
    "core.ui.pipelines.alerts.duplicate_heavy_ai.message":
      "This graph runs the same heavy AI step more than once for the same immediate input.",
    ...
    "core.ui.pipelines.alerts.side_effect_lossy_edge.message":
      "This edge declares blocking or lossless delivery but uses a lossy queue before a side-effect step.",
    "core.ui.pipelines.alerts.side_effect_lossy_edge.suggestion":
      "Use drop_policy='block', or explicitly declare that update loss is acceptable on this edge.",
    ...
    "core.ui.pipelines.alerts.edge_policy_mismatch.suggestion":
      "Use latest_only/drop_oldest, reduce the source rate, or declare this edge lossless.",
    ...
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_motion.message": "Publish video is marked as continuous, but motion gate '{{source_node_id}}' makes this path event-driven.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_motion.suggestion": "Mark the input edge as non-continuous when the gate is intentional, or use a separate continuous visual branch.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_detection.message": "Publish video is marked as continuous, but detection '{{source_node_id}}' makes this path event-driven.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_detection.suggestion": "Mark the input edge as non-continuous when event gating is intentional, or use a separate continuous visual branch.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_tracking.message": "Publish video is marked as continuous, but tracking '{{source_node_id}}' emits object lifecycle events on this path.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_tracking.suggestion": "Mark the input edge as non-continuous when event gating is intentional, or use a separate continuous visual branch.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_group_events.message": "Publish video is marked as continuous, but grouped events '{{source_node_id}}' emit group lifecycle events on this path.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_group_events.suggestion": "Mark the input edge as non-continuous when event gating is intentional, or use a separate continuous visual branch.",
    ...
    "core.ui.pipelines.topology.view": "View",
    "core.ui.pipelines.topology.title": "Topology",
    "core.ui.pipelines.topology.editing": "Editing",
    ...
    "core.ui.pipelines.topology.no_operators": "No operators found.",
    "core.ui.pipelines.topology.empty": "This graph has no nodes yet.",
    "core.ui.pipelines.topology.summary": "Topology",
    "core.ui.pipelines.topology.editable": "Editable graph v2",
    "core.ui.pipelines.topology.read_only": "Read-only graph view",
    "core.ui.pipelines.topology.runtime.loading": "checking",
    "core.ui.pipelines.topology.runtime.error": "error",
    "core.ui.pipelines.topology.runtime.unavailable": "unavailable",
    "core.ui.pipelines.topology.runtime.stale": "stale",
    ...
    "core.ui.pipelines.topology.runtime.active": "active",
    "core.ui.pipelines.topology.runtime.running": "running",
    "core.ui.pipelines.topology.runtime.stopped": "stopped",
    "core.ui.pipelines.topology.runtime.failed": "failed",
    "core.ui.pipelines.topology.runtime.canceled": "canceled",
    "core.ui.pipelines.topology.runtime.completed": "completed",
    "core.ui.pipelines.topology.runtime.degraded": "degraded",
    "core.ui.pipelines.topology.resource.none": "none",
    "core.ui.pipelines.topology.resource.camera": "camera",
    "core.ui.pipelines.topology.resource.vision_model": "vision model",
    "core.ui.pipelines.topology.resource.stream_writer": "stream writer",
    "core.ui.pipelines.topology.resource.network_service": "network service",
    "core.ui.pipelines.topology.resource.storage": "storage",
    "core.ui.pipelines.topology.resource.home_assistant": "Home Assistant",
    "core.ui.pipelines.topology.pressure_state.none": "none",
    "core.ui.pipelines.topology.pressure_state.warning": "warning",
    "core.ui.pipelines.topology.pressure_state.critical": "critical",
    "core.ui.pipelines.topology.pressure_state.error": "error",
    "core.ui.pipelines.topology.pressure_behavior.ignore": "ignore pressure",
    "core.ui.pipelines.topology.pressure_behavior.skip_before_compute": "skip before compute",
    "core.ui.pipelines.topology.pressure_behavior.pause_source": "pause source",
    "core.ui.pipelines.topology.pressure_behavior.reduce_source_rate": "reduce source rate",
    "core.ui.pipelines.topology.pressure_behavior.block": "block",
    "core.ui.pipelines.topology.pressure_behavior.fail_fast": "fail fast",
    "core.ui.pipelines.topology.pressure_cause.none": "none",
    "core.ui.pipelines.topology.pressure_cause.queue_full": "queue full",
    "core.ui.pipelines.topology.pressure_cause.drop_policy": "drop policy",
    "core.ui.pipelines.topology.pressure_cause.put_timeout": "write timed out",
    "core.ui.pipelines.topology.pressure_cause.put_canceled": "write canceled",
    "core.ui.pipelines.topology.pressure_cause.artifact_budget": "artifact memory budget",
    "core.ui.pipelines.topology.pressure_cause.structural_backlog": "structural backlog",
    ...
    "core.ui.pipelines.topology.alerts": "Alerts",
    "core.ui.pipelines.topology.alert_count_one": "1 alert",
    "core.ui.pipelines.topology.alert_count_many": "{{count}} alerts",
    "core.ui.pipelines.topology.advanced": "Advanced",
    "core.ui.pipelines.topology.advanced_json": "Advanced JSON",
    "core.ui.pipelines.topology.insert_unavailable": "Automatic insertion is not available in topology yet.",
    "core.ui.pipelines.topology.config_object": "Config must be a JSON object.",
    "core.ui.pipelines.topology.config": "Config",
    "core.ui.pipelines.topology.connection.title": "Connect nodes",
    "core.ui.pipelines.topology.connection.output": "Output port",
    "core.ui.pipelines.topology.connection.destination": "Destination node and input port",
    "core.ui.pipelines.topology.connection.choose": "Choose a port",
    "core.ui.pipelines.topology.connection.connect": "Connect",
    "core.ui.pipelines.topology.connection.success": "Connection added. Save the pipeline to keep it.",
    "core.ui.pipelines.topology.connection.hint": "Choose the receiving node and port. Occupied inputs and cycles are rejected. New connections use the operators' default queue policies.",
    ...
    "core.ui.pipelines.topology.field.nodes": "Nodes",
    "core.ui.pipelines.topology.field.edges": "Edges",
    "core.ui.pipelines.topology.field.sources": "Sources",
    "core.ui.pipelines.topology.field.sinks": "Sinks",
    "core.ui.pipelines.topology.field.runtime": "Runtime",
    "core.ui.pipelines.topology.field.pressure": "Pressure",
    "core.ui.pipelines.topology.field.updated": "Updated",
    "core.ui.pipelines.topology.field.node_id": "Node ID",
    "core.ui.pipelines.topology.field.uid": "UID",
    "core.ui.pipelines.topology.field.resource": "Resource",
    "core.ui.pipelines.topology.field.behavior": "Behavior",
    "core.ui.pipelines.topology.field.processed": "Processed",
    ...
    "core.ui.pipelines.topology.field.continuous": "Continuous",
    "core.ui.pipelines.topology.field.depth": "Depth",
    "core.ui.pipelines.topology.field.utilization": "Utilization",
    "core.ui.pipelines.topology.field.cause": "Cause",
    "core.ui.pipelines.topology.field.blocked_put_ms": "Blocked put ms",
    "core.ui.pipelines.topology.field.waiting_get_ms": "Waiting get ms",
    "core.ui.pipelines.topology.field.oldest_packet_ms": "Oldest packet ms",
    "core.ui.pipelines.topology.field.artifact_bytes": "Artifact bytes",
    "core.ui.pipelines.topology.fallback.graph_unavailable.title": "Graph unavailable",
    "core.ui.pipelines.topology.fallback.graph_unavailable.detail": "The pipeline graph is not a JSON object.",
    "core.ui.pipelines.topology.fallback.needs_v2.title": "Unsupported graph schema",
    "core.ui.pipelines.topology.fallback.needs_v2.detail": "Pipeline graphs must use schema_version=2.",
    "core.ui.pipelines.topology.fallback.incomplete.title": "Graph v2 is incomplete",
    "core.ui.pipelines.topology.fallback.incomplete.detail": "The topology view needs nodes and edges arrays.",
    "core.ui.pipelines.topology.error.requires_v2": "Topology editing requires graph schema v2.",
    "core.ui.pipelines.topology.error.node_not_found": "Node '{{nodeId}}' was not found.",
    "core.ui.pipelines.topology.error.edge_not_found": "Edge '{{edgeId}}' was not found.",
    "core.ui.pipelines.topology.error.connection_needs_nodes": "Connection must have source and target nodes.",
    "core.ui.pipelines.topology.error.self_connection": "A node cannot connect to itself in a DAG.",
    "core.ui.pipelines.topology.error.connection_missing_node": "Connection references a node that no longer exists.",
    ...
    "core.ui.pipelines.operator_name.camera.person_ground_estimate": "Estimate person and feet on the map",
    "core.ui.pipelines.operator_name.camera.pointing_target": "Estimate the pointed target on the map",
    "core.ui.pipelines.operator_description.camera.pointing_target": "Align image-derived 3D pose with calibrated geometry and return target candidates without enabling actions.",
    "core.ui.pipelines.panels.human_motion.pointing_help": "Connect after person and foot estimation. Uses the calibrated camera and its saved map, the model's three-dimensional pose and recent compatible support. Keep gesture output in annotation mode on this branch.",
    "core.ui.pipelines.panels.human_motion.pointing_limits": "Observation only. Stationary support is a hypothesis, not a contact measurement. Multiple targets remain ambiguous. Walls need measured physical height; incomplete geometry prevents a confident selection. Accuracy is not yet qualified.",
    "core.ui.pipelines.panels.human_motion.pointing_arm": "Pointing arm",
    "core.ui.pipelines.panels.human_motion.arm_auto": "Automatic — only an unambiguous arm",
    "core.ui.pipelines.panels.human_motion.arm_left": "Person's left arm",
    "core.ui.pipelines.panels.human_motion.arm_right": "Person's right arm",
    "core.ui.pipelines.panels.human_motion.pointing_distance": "Maximum target distance (meters)",
    "core.ui.pipelines.panels.human_motion.pointing_cone": "Uncertainty cone half-angle (degrees, uncalibrated)",
    "core.ui.pipelines.panels.human_motion.reprojection": "Maximum reprojection error (image fraction)",
    "core.ui.pipelines.panels.human_motion.frame_age_seconds": "Maximum frame age (seconds)",
    "core.ui.pipelines.panels.human_motion.wave_window": "Wave observation window (seconds)",
    "core.ui.pipelines.panels.human_motion.wave_reversals": "Minimum direction reversals for a wave",
    "core.ui.pipelines.operator_name.vision.gesture_recognize": "Recognize gestures over time",
    "core.ui.pipelines.operator_description.camera.person_ground_estimate": "Separate body and foot hypotheses using calibrated geometry and optional recent history.",
    "core.ui.pipelines.operator_description.vision.gesture_recognize": "Recognize raised hands, waving and pointing candidates without enabling physical actions.",
    "core.ui.pipelines.panels.human_motion.enabled": "Enabled",
    "core.ui.pipelines.panels.human_motion.ground_help": "Connect after tracking and pose estimation. Body location and each foot remain separate estimates; the original person position is preserved.",
    "core.ui.pipelines.panels.human_motion.composition": "Calibrated map",
    "core.ui.pipelines.panels.human_motion.composition_from_camera": "Use the camera's calibrated map",
    "core.ui.pipelines.panels.human_motion.saved_composition": "Saved map: {{id}} (not available in this camera context)",
    "core.ui.pipelines.panels.human_motion.metric_help": "Ground mapping alone is insufficient. In the camera's map calibration, provide measured lens intrinsics, at least six fitting points and two independent check points. A fixed, matching view is required.",
    "core.ui.pipelines.panels.human_motion.complete_feet": "Estimate hidden feet from recent stationary support",
    "core.ui.pipelines.panels.human_motion.completion_help": "Optional. Predictions expire and uncertainty grows. A hidden foot is never labelled as observed; without sufficient evidence its position remains unavailable.",
    "core.ui.pipelines.panels.human_motion.height_min": "Minimum assumed stature (meters)",
    "core.ui.pipelines.panels.human_motion.height_max": "Maximum assumed stature (meters)",
    "core.ui.pipelines.panels.human_motion.height_order": "Maximum stature must be at least the minimum.",
    "core.ui.pipelines.panels.human_motion.height_help": "This is a broad uniform assumption, not a measured height or demographic estimate. Narrow it only when independent measurements justify it.",
    "core.ui.pipelines.panels.human_motion.range": "Enter a value between {{minimum}} and {{maximum}}.",
    "core.ui.pipelines.panels.human_motion.history": "Maximum history age (seconds)",
    "core.ui.pipelines.panels.human_motion.score": "Minimum model score (0–1, not a probability)",
    "core.ui.pipelines.panels.human_motion.frame_age_ms": "Maximum frame age (milliseconds)",
    "core.ui.pipelines.panels.human_motion.gesture_help": "Recognizes one raised hand, both raised hands, waving and a pointing candidate. Uses the body's orientation; a 2D pointing candidate is not a spatial target.",
    "core.ui.pipelines.panels.human_motion.output": "Output mode",
    "core.ui.pipelines.panels.human_motion.annotate": "Annotate person packets",
    "core.ui.pipelines.panels.human_motion.events": "Emit separate gesture events",
    "core.ui.pipelines.panels.human_motion.no_physical_actions": "No physical action is enabled. Event mode replaces the outgoing person stream with gesture events; use a separate branch to keep both.",
    "core.ui.pipelines.panels.human_motion.minimum_duration": "Minimum gesture duration (seconds)",
    "core.ui.pipelines.panels.human_motion.release": "Release delay (seconds)",
    "core.ui.pipelines.panels.human_motion.cooldown": "Cooldown between events (seconds)",
    "core.ui.pipelines.panels.human_motion.gap": "Maximum gap between samples (seconds)",
    ...
    "core.ui.pipelines.operator_name.ptz_attention.request": "Focus PTZ on event",
    "core.ui.pipelines.operator_description.ptz_attention.request": "Directs a calibrated PTZ camera to a mapped event while it remains active.",
    ...
    "core.ui.pipelines.editor.error.invalid_graph_json": "Invalid graph JSON: {{error}}",
    "core.ui.pipelines.editor.error.interactive_graph_invalid": "Interactive graph is invalid.",
    "core.ui.pipelines.editor.error.graph_json_object": "Graph JSON must be an object.",
    "core.ui.pipelines.editor.error.python_source_required": "Python source is required in Python mode.",
    ...
    "core.ui.pipelines.panels.throttle.key.event_id": "Subject ID",
    ...
    "core.ui.pipelines.panels.debounce.key.event_id": "Subject ID",
    ...
    "core.ui.pipelines.storage.confirm_clean": "Clear all stored files for '{{name}}'?",
    ...
    "core.ui.pipelines.panels.notify.ephemeral_image": "Live image, without saving",
    "core.ui.pipelines.panels.notify.ephemeral_image_hint": "Optional, realtime only. Sends an image only to the selected notification detail, expiring within 750 ms of source publication. It is not saved in history and disappears on disconnect or selection change.",
    ...
    "core.ui.pipelines.panels.notify.payload_paths": "Additional payload fields (optional)",
    "core.ui.pipelines.panels.notify.payload_paths_placeholder": "Enter a field path and press Enter",
    "core.ui.pipelines.panels.notify.payload_paths_add": "Include {{path}}",
    "core.ui.pipelines.panels.notify.payload_paths_hint": "Up to 16 paths, such as vision.poses; use names separated by dots, without wildcards. These fields are stored with the notification, but image pixels are not saved. Missing or oversized data is reported as unavailable. Leave empty to keep the default payload.",
    ...
    "core.ui.pipelines.panels.home_assistant_boolean_state.server": "Home Assistant server",
    "core.ui.pipelines.panels.home_assistant_boolean_state.server_placeholder": "Select a server…",
    "core.ui.pipelines.panels.home_assistant_boolean_state.server_loading": "Loading Home Assistant servers…",
    "core.ui.pipelines.panels.home_assistant_boolean_state.server_load_failed": "Failed to load Home Assistant servers: {{error}}",
    "core.ui.pipelines.panels.home_assistant_boolean_state.server_empty":
      "No Home Assistant servers configured. Add one in Settings > Home Assistant first.",
    "core.ui.pipelines.panels.home_assistant_boolean_state.target_mode": "Signal",
    "core.ui.pipelines.panels.home_assistant_boolean_state.target_mode.managed_state": "Create binary sensor",
    "core.ui.pipelines.panels.home_assistant_boolean_state.target_mode.existing_input_boolean": "Use input_boolean",
    "core.ui.pipelines.panels.home_assistant_boolean_state.managed_name": "Name",
    "core.ui.pipelines.panels.home_assistant_boolean_state.managed_name_placeholder": "Garage motion",
    "core.ui.pipelines.panels.home_assistant_boolean_state.managed_entity_preview": "{{entity_id}}",
    "core.ui.pipelines.panels.home_assistant_boolean_state.managed_name_required": "Name the Home Assistant signal.",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class": "Type",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.motion": "Motion",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.occupancy": "Occupancy",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.presence": "Presence",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.opening": "Opening",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.problem": "Problem",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.tamper": "Tamper",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.none": "No type",
    "core.ui.pipelines.panels.home_assistant_boolean_state.existing_entity": "Helper",
    "core.ui.pipelines.panels.home_assistant_boolean_state.existing_entity_placeholder": "Select input_boolean…",
    "core.ui.pipelines.panels.home_assistant_boolean_state.existing_select_server_first": "Select a server first.",
    "core.ui.pipelines.panels.home_assistant_boolean_state.existing_loading": "Loading helpers…",
    "core.ui.pipelines.panels.home_assistant_boolean_state.existing_load_failed": "Failed to load helpers: {{error}}",
    "core.ui.pipelines.panels.home_assistant_boolean_state.existing_empty": "No input_boolean helpers found.",
    "core.ui.pipelines.panels.home_assistant_boolean_state.existing_required": "Choose an input_boolean helper.",
    "core.ui.pipelines.panels.home_assistant_boolean_state.boolean_path": "Boolean field",
    "core.ui.pipelines.panels.home_assistant_boolean_state.boolean_path_placeholder": "payload.onvif_event.boolean_value",
    "core.ui.pipelines.panels.home_assistant_boolean_state.shutdown_behavior": "When pipeline stops",
    "core.ui.pipelines.panels.home_assistant_boolean_state.shutdown_behavior.off": "Turn off",
    "core.ui.pipelines.panels.home_assistant_boolean_state.shutdown_behavior.unavailable": "Mark unavailable",
    "core.ui.pipelines.panels.home_assistant_boolean_state.shutdown_behavior.keep": "Keep last state",
    ...
    "core.ui.pipelines.panels.pose.model_hint": "Choose a body pose model on the selected processing server. Add person detection before this step; pose reuses those people instead of running another detector.",
    "core.ui.pipelines.panels.pose.catalog_loading": "Loading pose models from {{serverId}}…",
    "core.ui.pipelines.panels.pose.catalog_failed": "Pose model availability could not be checked on {{serverId}}. Check the connection and refresh the list.",
    "core.ui.pipelines.panels.pose.install_hint": "This model is not ready on {{serverId}} yet. Install it here before running this pipeline.",
    "core.ui.pipelines.panels.pose.catalog_empty": "No pose models are registered on {{serverId}}. Open processing servers to import a compatible pose manifest, then refresh this list.",
    "core.ui.pipelines.panels.pose.select_model": "Select a pose model to check availability and prepare it on {{serverId}}.",
    "core.ui.pipelines.panels.pose.model_missing": "The saved model {{model}} is not registered for pose on {{serverId}}. Select another model or import its manifest on this server.",
    "core.ui.pipelines.panels.pose.unavailable": "This model cannot run here: {{reason}}. Choose a compatible model or check this processing server.",
    "core.ui.pipelines.panels.pose.install_started": "Installation of {{model}} started on {{serverId}}.",
    "core.ui.pipelines.panels.pose.input_artifact": "Image to analyze",
    "core.ui.pipelines.panels.pose.input_automatic": "Current pipeline image (automatic)",
    "core.ui.pipelines.panels.pose.input_hint": "Choose an image from upstream steps. Pose coordinates retain their relationship to the original camera image after cropping or resizing.",
    "core.ui.pipelines.panels.pose.max_poses": "Maximum people per frame",
    "core.ui.pipelines.panels.pose.max_poses_hint": "1–512 people. This limits pose inference for each frame; it does not create or track people.",
    "core.ui.pipelines.panels.pose.max_poses_error": "Enter a whole number from 1 to 512 people.",
    ...
    "core.ui.pipelines.panels.yolo.local_build.start": "Download and prepare automatically",
    ...
    "core.ui.pipelines.panels.yolo.provisioning.catalog_checking": "Checking model availability on {{serverId}}…",
    "core.ui.pipelines.panels.yolo.provisioning.catalog_failed": "Could not check model availability on {{serverId}}. Refresh the catalog to try again.",
    "core.ui.pipelines.panels.yolo.provisioning.catalog_unavailable": "The model catalog is unavailable on {{serverId}}. Readiness has not been verified.",
    "core.ui.pipelines.panels.yolo.provisioning.catalog_model_missing": "Model {{model}} was not found in the catalog for {{serverId}}. Select a listed model or refresh the catalog.",
    "core.ui.pipelines.panels.yolo.provisioning.catalog_select_model": "Select a model from the catalog for {{serverId}}.",
    ...
    "core.ui.pipelines.panels.yolo.detect_annotate_only_hint":
      "vision.detect keeps results attached to the frame. Add vision.track when downstream steps need stable object events.",
    ...
    "core.ui.processing_servers.status.online_with_errors": "online, pipeline errors",
    ...
    "core.ui.processing_servers.runtime_issues.badge": "Runtime",
    "core.ui.processing_servers.runtime_issues.summary": "{{count}} runtime node issue(s)",
    "core.ui.processing_servers.runtime_issues.node": "{{pipeline}} / {{node}} failed {{count}} time(s)",
    ...
    "core.ui.processing_servers.vision_recommendations.manifest_only": "needs model file",
    "core.ui.processing_servers.vision_recommendations.needs_model_file": "needs model file",
    ...
    "core.ui.processing_servers.origin_metrics.item": "{{count}} {{label}}",
    "core.ui.processing_servers.origin_metrics.models_unknown": "{{count}} models without registered origin",
    "core.ui.processing_servers.origin_metrics.jobs_unknown": "{{count}} jobs without registered source",
    ...
    "core.ui.processing_servers.custom_catalog.availability.manifest_only": "needs model file",
    ...
    "core.ui.processing_server_modal.connection_runtime_errors": "Connection: OK, but {{count}} runtime node issue(s)",
  ...
  "pt-BR": {
    ...
    "core.ui.notifications.live": "Ao vivo",
    "core.ui.notifications.group_presence.description": "Presença em andamento{{camera_suffix}}",
    "core.ui.notifications.group_presence.closed_description": "Presença finalizada{{camera_suffix}}",
    ...
    "core.ui.notifications.details.meta.observed_duration": "Duração até a última atualização",
    "core.ui.notifications.details.meta.clock_changed": "Referência temporal alterada; duração indisponível",
    "core.ui.notifications.details.meta.invalid_interval": "Intervalo temporal inválido; duração indisponível",
    ...
    "core.ui.settings.sections.compositions": "Composições",
    "core.ui.settings.sections.compositions_desc": "Crie, selecione e edite composições.",
    ...
    "core.ui.settings.sidebar.main": "Principal",
    "core.ui.settings.sidebar.system": "Sistema",
    "core.ui.settings.sidebar.admin": "Administração",
    ...
    "core.ui.settings.confirm_open_composition_editor_title": "Descartar alterações e abrir o editor de composição?",
    ...
    "core.ui.settings.compositions.create": "Criar",
    "core.ui.settings.compositions.list_desc": "{{count}} composição(ões) disponível(is).",
    "core.ui.settings.compositions.active": "Ativa",
    "core.ui.settings.compositions.available": "Disponível",
    "core.ui.settings.compositions.open_editor": "Abrir editor",
    "core.ui.settings.compositions.empty": "Nenhuma composição encontrada.",
    "core.ui.settings.compositions.aria.active": "{{name}} é a composição ativa",
    "core.ui.settings.compositions.aria.select": "Selecionar composição {{name}}",
    "core.ui.settings.compositions.aria.open_editor": "Abrir editor de {{name}}",
    "core.ui.settings.compositions.error.open_editor": "Falha ao abrir o editor de composição",
    "core.ui.settings.extensions.loading": "Carregando extensões…",
    "core.ui.settings.extensions.search_placeholder": "Buscar extensões…",
    "core.ui.settings.extensions.manual_label": "Pacote, URL do GitHub ou caminho local",
    "core.ui.settings.extensions.manual_placeholder": "toposync-ext-exemplo, https://github.com/org/toposync-ext-exemplo ou /caminho/toposync-ext-exemplo",
    "core.ui.settings.extensions.manual_hint": "Pacotes PyPI precisam começar com toposync-ext-. Caminhos locais instalam em modo editável por padrão.",
    "core.ui.settings.extensions.trust_title": "Extensões executam código local",
    "core.ui.settings.extensions.trust_desc": "Instale apenas extensões de autores e repositórios em que você confia.",
    "core.ui.settings.extensions.browser_activation_failed": "A ativação no navegador falhou: {{error}}",
    ...
    "core.ui.settings.extensions.editable": "editável",
    ...
    "core.ui.settings.extensions.source_kind.github": "GitHub",
    "core.ui.settings.extensions.source_kind.git": "Git",
    "core.ui.settings.extensions.source_kind.local": "caminho local",
    ...
    "core.ui.render_modal.option_3d.title": "3D",
    "core.ui.render_modal.option_3d.desc": "Navegue pelo ambiente em uma cena tridimensional.",
    "core.ui.render_modal.option_2d.title": "2D (Imagem)",
    ...
    "core.ui.streams.variant.select": "Variante da câmera ao vivo",
    "core.ui.streams.variant.set_default": "Definir como padrão para este uso",
    "core.ui.streams.variant.auto": "Auto",
    "core.ui.streams.variant.low": "Baixa",
    "core.ui.streams.variant.stable": "Estável",
    "core.ui.streams.variant.high": "Alta",
    "core.ui.streams.variant.zoom": "Zoom",
    "core.ui.streams.variant.low_latency": "Baixa latência",
    "core.ui.streams.variant.custom": "Personalizada",
    "core.ui.streams.context.thumbnail": "Miniatura",
    "core.ui.streams.context.pip": "PiP",
    "core.ui.streams.context.large": "Tela grande",
    "core.ui.streams.context.fullscreen": "Tela cheia",
    "core.ui.streams.context.ptz": "PTZ",
    ...
    "core.ui.streams.advanced.state": "Estado",
    "core.ui.streams.advanced.state_label": "Estado",
    "core.ui.streams.advanced.state_message": "Mensagem",
    "core.ui.streams.advanced.state_action": "Ação recomendada",
    "core.ui.streams.advanced.technical_status": "Status técnico",
    "core.ui.streams.advanced.playback": "Reprodução",
    "core.ui.streams.advanced.player_status": "Estado do player",
    "core.ui.streams.advanced.active_transport": "Transporte ativo",
    "core.ui.streams.advanced.effective_mode": "Modo efetivo",
    "core.ui.streams.advanced.transport_preference": "Preferência de transporte",
    "core.ui.streams.advanced.quality_preference": "Preferência de qualidade",
    "core.ui.streams.advanced.low_latency_requested": "Baixa latência solicitada",
    "core.ui.streams.advanced.hls_fallback": "Fallback HLS",
    "core.ui.streams.advanced.hls_public_base_path": "Base pública HLS",
    "core.ui.streams.advanced.hls_ingress_prefix": "Prefixo ingress na URL HLS",
    "core.ui.streams.advanced.hls_media_origin": "Origem de mídia HLS",
    "core.ui.streams.advanced.last_hls_probe": "Último probe HLS",
    "core.ui.streams.advanced.hls_health": "Saúde HLS",
    "core.ui.streams.advanced.webrtc_contract": "Contrato WebRTC",
    "core.ui.streams.advanced.player_error": "Erro do player",
    "core.ui.streams.advanced.current_hint": "Mensagem atual",
    "core.ui.streams.advanced.selected_output": "Saída selecionada",
    "core.ui.streams.advanced.runtime": "Diagnóstico técnico",
    "core.ui.streams.advanced.runtime_status": "Status do runtime",
    "core.ui.streams.advanced.classification": "Classificação",
    "core.ui.streams.advanced.selected_frame_age": "Idade do frame selecionado",
    "core.ui.streams.advanced.last_incoming_age": "Idade do último frame recebido",
    "core.ui.streams.advanced.last_live_frame": "Último frame ao vivo",
    "core.ui.streams.advanced.fallback_active": "Fallback ativo",
    "core.ui.streams.advanced.fallback_reason": "Motivo do fallback",
    "core.ui.streams.advanced.placeholder_active": "Placeholder ativo",
    "core.ui.streams.advanced.active_writer": "Writer ativo",
    "core.ui.streams.advanced.selected_writer": "Writer selecionado",
    "core.ui.streams.advanced.stream_behavior": "Comportamento do stream",
    "core.ui.streams.advanced.active_sessions": "Sessões ativas",
    ...
    "core.ui.streams.summary.working": "Funcionando",
    "core.ui.streams.summary.warming": "Aquecendo, aguarde",
    "core.ui.streams.summary.action_required": "Ação necessária",
    "core.ui.streams.summary.unknown": "Sem leitura",
    "core.ui.streams.summary.message.working": "Funcionando.",
    "core.ui.streams.summary.message.waiting_demand": "Aquecendo quando houver visualização.",
    "core.ui.streams.summary.message.waiting_event": "Aquecendo, aguardando evento.",
    "core.ui.streams.summary.message.warming_playback": "Aquecendo transmissão, aguarde alguns segundos.",
    "core.ui.streams.summary.message.recovering_fallback": "Aquecendo com frame de fallback.",
    "core.ui.streams.summary.message.waiting_first_frame": "Aquecendo, aguardando primeiro frame.",
    "core.ui.streams.summary.message.warming": "Aquecendo, aguarde.",
    "core.ui.streams.summary.message.action_required": "Ação necessária.",
    ...
    "core.ui.streams.health.demand_idle": "Aguardando visualizador para iniciar a captura.",
    "core.ui.streams.health.demand_idle_label": "Aguardando visualizador",
    ...
    "core.ui.pipelines.status.read_only": "somente leitura",
    "core.ui.pipelines.generated.separator": "Fluxos gerados automaticamente",
    "core.ui.pipelines.generated.show": "Mostrar fluxos gerados automaticamente",
    "core.ui.pipelines.generated.hide": "Ocultar fluxos gerados automaticamente",
    "core.ui.pipelines.read_only.badge": "Somente leitura",
    "core.ui.pipelines.read_only.message": "Este fluxo gerado é gerenciado pela origem e só pode ser inspecionado aqui.",
    "core.ui.pipelines.read_only.error": "Fluxos gerados são somente leitura aqui.",
    ...
    "core.ui.pipelines.telemetry.metric.onvif_gate_open": "Condição ONVIF",
    ...
    "core.ui.pipelines.alerts.notify_thumbnail_not_stored.message": "Enviar notificação prefere o artefato '{{input_artifact_name}}', mas Salvar imagens nas etapas anteriores armazena {{stored_artifacts}}; outra imagem armazenada será usada como alternativa.",
    "core.ui.pipelines.alerts.notify_thumbnail_not_stored.suggestion": "Armazene o mesmo artefato apenas quando a notificação precisar usar exatamente essa imagem.",
    ...
    "core.ui.pipelines.alerts.duplicate_heavy_ai.message":
      "Este grafo executa a mesma etapa pesada de IA mais de uma vez para a mesma entrada imediata.",
    "core.ui.pipelines.alerts.duplicate_heavy_ai.suggestion":
    ...
    "core.ui.pipelines.alerts.side_effect_lossy_edge.message":
      "Esta conexão declara entrega bloqueante ou sem perda, mas usa uma fila com descarte antes de uma etapa de efeito externo.",
    "core.ui.pipelines.alerts.side_effect_lossy_edge.suggestion":
      "Use drop_policy='block' ou declare explicitamente que a perda de atualizações é aceitável nesta conexão.",
    "core.ui.pipelines.alerts.edge_policy_mismatch.message":
      "Uma edge de vídeo contínuo usa política block, o que pode travar captura em tempo real ou IA anterior sob pressão.",
    "core.ui.pipelines.alerts.edge_policy_mismatch.suggestion":
      "Use latest_only/drop_oldest, reduza a taxa da origem ou declare que esta conexão precisa ser sem perda.",
    ...
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_motion.message": "Transmitir vídeo está marcado como contínuo, mas o gate de movimento '{{source_node_id}}' torna este caminho orientado a eventos.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_motion.suggestion": "Marque a conexão de entrada como não contínua quando o gate for intencional, ou use um ramo visual contínuo separado.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_detection.message": "Transmitir vídeo está marcado como contínuo, mas a detecção '{{source_node_id}}' torna este caminho orientado a eventos.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_detection.suggestion": "Marque a conexão de entrada como não contínua quando o gate for intencional, ou use um ramo visual contínuo separado.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_tracking.message": "Transmitir vídeo está marcado como contínuo, mas o rastreamento '{{source_node_id}}' emite eventos de ciclo de vida dos objetos neste caminho.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_tracking.suggestion": "Marque a conexão de entrada como não contínua quando o gate for intencional, ou use um ramo visual contínuo separado.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_group_events.message": "Transmitir vídeo está marcado como contínuo, mas os eventos agrupados '{{source_node_id}}' emitem ciclos de vida de grupos neste caminho.",
    "core.ui.pipelines.alerts.stream_publish_video_event_gated_group_events.suggestion": "Marque a conexão de entrada como não contínua quando o gate for intencional, ou use um ramo visual contínuo separado.",
    ...
    "core.ui.pipelines.topology.view": "Visualização",
    "core.ui.pipelines.topology.title": "Topologia",
    "core.ui.pipelines.topology.editing": "Editando",
    ...
    "core.ui.pipelines.topology.no_operators": "Nenhum operador encontrado.",
    "core.ui.pipelines.topology.empty": "Este grafo ainda não tem nós.",
    "core.ui.pipelines.topology.summary": "Topologia",
    "core.ui.pipelines.topology.editable": "Grafo v2 editável",
    "core.ui.pipelines.topology.read_only": "Visualização do grafo somente leitura",
    "core.ui.pipelines.topology.runtime.loading": "verificando",
    "core.ui.pipelines.topology.runtime.error": "erro",
    "core.ui.pipelines.topology.runtime.unavailable": "indisponível",
    "core.ui.pipelines.topology.runtime.stale": "desatualizado",
    "core.ui.pipelines.topology.runtime.ready": "pronto",
    "core.ui.pipelines.topology.runtime.idle": "ocioso",
    "core.ui.pipelines.topology.runtime.no_runtime": "sem execução",
    "core.ui.pipelines.topology.runtime.active": "ativo",
    "core.ui.pipelines.topology.runtime.running": "em execução",
    "core.ui.pipelines.topology.runtime.stopped": "parado",
    "core.ui.pipelines.topology.runtime.failed": "com falha",
    "core.ui.pipelines.topology.runtime.canceled": "cancelado",
    "core.ui.pipelines.topology.runtime.completed": "concluído",
    "core.ui.pipelines.topology.runtime.degraded": "degradado",
    "core.ui.pipelines.topology.resource.none": "nenhum",
    "core.ui.pipelines.topology.resource.camera": "câmera",
    "core.ui.pipelines.topology.resource.vision_model": "modelo de visão",
    "core.ui.pipelines.topology.resource.stream_writer": "gravador de fluxo",
    "core.ui.pipelines.topology.resource.network_service": "serviço de rede",
    "core.ui.pipelines.topology.resource.storage": "armazenamento",
    "core.ui.pipelines.topology.resource.home_assistant": "Home Assistant",
    "core.ui.pipelines.topology.pressure_state.none": "nenhuma",
    "core.ui.pipelines.topology.pressure_state.warning": "aviso",
    "core.ui.pipelines.topology.pressure_state.critical": "crítica",
    "core.ui.pipelines.topology.pressure_state.error": "erro",
    "core.ui.pipelines.topology.pressure_behavior.ignore": "ignorar pressão",
    "core.ui.pipelines.topology.pressure_behavior.skip_before_compute": "pular antes de processar",
    "core.ui.pipelines.topology.pressure_behavior.pause_source": "pausar fonte",
    "core.ui.pipelines.topology.pressure_behavior.reduce_source_rate": "reduzir taxa da fonte",
    "core.ui.pipelines.topology.pressure_behavior.block": "bloquear",
    "core.ui.pipelines.topology.pressure_behavior.fail_fast": "falhar imediatamente",
    "core.ui.pipelines.topology.pressure_cause.none": "nenhuma",
    "core.ui.pipelines.topology.pressure_cause.queue_full": "fila cheia",
    "core.ui.pipelines.topology.pressure_cause.drop_policy": "política de descarte",
    "core.ui.pipelines.topology.pressure_cause.put_timeout": "tempo esgotado na escrita",
    "core.ui.pipelines.topology.pressure_cause.put_canceled": "escrita cancelada",
    "core.ui.pipelines.topology.pressure_cause.artifact_budget": "limite de memória de artefatos",
    "core.ui.pipelines.topology.pressure_cause.structural_backlog": "acúmulo estrutural",
    ...
    "core.ui.pipelines.topology.alerts": "Alertas",
    "core.ui.pipelines.topology.alert_count_one": "1 alerta",
    "core.ui.pipelines.topology.alert_count_many": "{{count}} alertas",
    "core.ui.pipelines.topology.advanced": "Avançado",
    "core.ui.pipelines.topology.advanced_json": "JSON avançado",
    "core.ui.pipelines.topology.insert_unavailable": "Inserção automática ainda não está disponível na topologia.",
    "core.ui.pipelines.topology.config_object": "A configuração precisa ser um objeto JSON.",
    "core.ui.pipelines.topology.config": "Configuração",
    "core.ui.pipelines.topology.connection.title": "Conectar nós",
    "core.ui.pipelines.topology.connection.output": "Porta de saída",
    "core.ui.pipelines.topology.connection.destination": "Nó e porta de entrada de destino",
    "core.ui.pipelines.topology.connection.choose": "Escolha uma porta",
    "core.ui.pipelines.topology.connection.connect": "Conectar",
    "core.ui.pipelines.topology.connection.success": "Conexão adicionada. Salve o fluxo para mantê-la.",
    "core.ui.pipelines.topology.connection.hint": "Escolha o nó e a porta que receberão os dados. Entradas ocupadas e ciclos são rejeitados. Novas conexões usam as políticas de fila padrão dos operadores.",
    ...
    "core.ui.pipelines.topology.edge_data_unavailable": "Dados da aresta indisponíveis.",
    "core.ui.pipelines.topology.edge_label.video": "Vídeo",
    "core.ui.pipelines.topology.edge_label.event": "Evento",
    "core.ui.pipelines.topology.edge_label.gate": "Porta",
    ...
    "core.ui.pipelines.topology.modality.control_gate": "Sinal de porta",
    ...
    "core.ui.pipelines.topology.field.nodes": "Nós",
    "core.ui.pipelines.topology.field.edges": "Arestas",
    "core.ui.pipelines.topology.field.sources": "Fontes",
    "core.ui.pipelines.topology.field.sinks": "Saídas",
    "core.ui.pipelines.topology.field.runtime": "Execução",
    "core.ui.pipelines.topology.field.pressure": "Pressão",
    "core.ui.pipelines.topology.field.updated": "Atualizado",
    "core.ui.pipelines.topology.field.node_id": "ID do nó",
    "core.ui.pipelines.topology.field.uid": "UID",
    "core.ui.pipelines.topology.field.resource": "Recurso",
    "core.ui.pipelines.topology.field.behavior": "Comportamento",
    "core.ui.pipelines.topology.field.processed": "Processados",
    ...
    "core.ui.pipelines.topology.field.continuous_stream": "Fluxo contínuo",
    "core.ui.pipelines.topology.field.from": "Origem",
    "core.ui.pipelines.topology.field.to": "Destino",
    "core.ui.pipelines.topology.field.continuous": "Contínuo",
    "core.ui.pipelines.topology.field.depth": "Profundidade",
    "core.ui.pipelines.topology.field.utilization": "Utilização",
    "core.ui.pipelines.topology.field.cause": "Causa",
    "core.ui.pipelines.topology.field.blocked_put_ms": "Escrita bloqueada (ms)",
    "core.ui.pipelines.topology.field.waiting_get_ms": "Leitura em espera (ms)",
    "core.ui.pipelines.topology.field.oldest_packet_ms": "Pacote mais antigo (ms)",
    "core.ui.pipelines.topology.field.artifact_bytes": "Bytes de artefato",
    "core.ui.pipelines.topology.fallback.graph_unavailable.title": "Grafo indisponível",
    "core.ui.pipelines.topology.fallback.graph_unavailable.detail": "O grafo do fluxo não é um objeto JSON.",
    "core.ui.pipelines.topology.fallback.needs_v2.title": "Esquema de grafo não suportado",
    "core.ui.pipelines.topology.fallback.needs_v2.detail": "Fluxos precisam usar schema_version=2.",
    "core.ui.pipelines.topology.fallback.incomplete.title": "Grafo v2 incompleto",
    "core.ui.pipelines.topology.fallback.incomplete.detail": "A visualização de topologia precisa dos arrays de nós e arestas.",
    "core.ui.pipelines.topology.error.requires_v2": "A edição de topologia requer o esquema de grafo v2.",
    "core.ui.pipelines.topology.error.node_not_found": "Nó '{{nodeId}}' não encontrado.",
    "core.ui.pipelines.topology.error.edge_not_found": "Aresta '{{edgeId}}' não encontrada.",
    "core.ui.pipelines.topology.error.connection_needs_nodes": "A conexão precisa de nó de origem e nó de destino.",
    "core.ui.pipelines.topology.error.self_connection": "Um nó não pode conectar a si mesmo em uma DAG.",
    "core.ui.pipelines.topology.error.connection_missing_node": "A conexão referencia um nó que não existe mais.",
    "core.ui.pipelines.topology.error.input_taken": "{{target}} já tem uma aresta de entrada.",
    ...
    "core.ui.pipelines.operator_name.camera.person_ground_estimate": "Estimar pessoa e pés no mapa",
    "core.ui.pipelines.operator_name.camera.pointing_target": "Estimar alvo apontado no mapa",
    "core.ui.pipelines.operator_description.camera.pointing_target": "Alinha pose tridimensional de imagem com geometria calibrada e retorna candidatos a alvo sem habilitar ações.",
    "core.ui.pipelines.panels.human_motion.pointing_help": "Conecte depois da estimativa de pessoa e pés. Usa a câmera calibrada e seu mapa salvo, pose tridimensional do modelo e apoio recente compatível. Mantenha a saída de gestos no modo de anotação nesta ramificação.",
    "core.ui.pipelines.panels.human_motion.pointing_limits": "Somente observação. Apoio estacionário é hipótese, não medição de contato. Vários alvos permanecem ambíguos. Paredes precisam de altura física medida; geometria incompleta impede seleção confiável. Precisão ainda não qualificada.",
    "core.ui.pipelines.panels.human_motion.pointing_arm": "Braço de apontamento",
    "core.ui.pipelines.panels.human_motion.arm_auto": "Automático — somente um braço inequívoco",
    "core.ui.pipelines.panels.human_motion.arm_left": "Braço esquerdo da pessoa",
    "core.ui.pipelines.panels.human_motion.arm_right": "Braço direito da pessoa",
    "core.ui.pipelines.panels.human_motion.pointing_distance": "Distância máxima do alvo (metros)",
    "core.ui.pipelines.panels.human_motion.pointing_cone": "Meio ângulo do cone de incerteza (graus, não calibrado)",
    "core.ui.pipelines.panels.human_motion.reprojection": "Erro máximo de reprojeção (fração da imagem)",
    "core.ui.pipelines.panels.human_motion.frame_age_seconds": "Idade máxima do quadro (segundos)",
    "core.ui.pipelines.panels.human_motion.wave_window": "Janela de observação do aceno (segundos)",
    "core.ui.pipelines.panels.human_motion.wave_reversals": "Mínimo de inversões de direção para aceno",
    "core.ui.pipelines.operator_name.vision.gesture_recognize": "Reconhecer gestos ao longo do tempo",
    "core.ui.pipelines.operator_description.camera.person_ground_estimate": "Separa hipóteses do corpo e dos pés usando geometria calibrada e histórico recente opcional.",
    "core.ui.pipelines.operator_description.vision.gesture_recognize": "Reconhece mãos levantadas, aceno e candidatos a apontamento sem habilitar ações físicas.",
    "core.ui.pipelines.panels.human_motion.enabled": "Habilitado",
    "core.ui.pipelines.panels.human_motion.ground_help": "Conecte depois do rastreamento e da estimativa de pose. Corpo e cada pé permanecem estimativas separadas; a posição original da pessoa é preservada.",
    "core.ui.pipelines.panels.human_motion.composition": "Mapa calibrado",
    "core.ui.pipelines.panels.human_motion.composition_from_camera": "Usar o mapa calibrado da câmera",
    "core.ui.pipelines.panels.human_motion.saved_composition": "Mapa salvo: {{id}} (indisponível neste contexto de câmera)",
    "core.ui.pipelines.panels.human_motion.metric_help": "Mapear o chão não basta. Na calibração da câmera no mapa, informe os parâmetros medidos da lente, pelo menos seis pontos de ajuste e dois pontos independentes de checagem. A vista deve ser fixa e correspondente.",
    "core.ui.pipelines.panels.human_motion.complete_feet": "Estimar pés ocultos a partir de apoio estacionário recente",
    "core.ui.pipelines.panels.human_motion.completion_help": "Opcional. Previsões expiram e a incerteza cresce. Um pé oculto nunca é marcado como observado; sem evidência suficiente, sua posição permanece indisponível.",
    "core.ui.pipelines.panels.human_motion.height_min": "Estatura mínima assumida (metros)",
    "core.ui.pipelines.panels.human_motion.height_max": "Estatura máxima assumida (metros)",
    "core.ui.pipelines.panels.human_motion.height_order": "A estatura máxima deve ser maior ou igual à mínima.",
    "core.ui.pipelines.panels.human_motion.height_help": "É uma hipótese uniforme ampla, não altura medida nem estimativa demográfica. Restrinja somente quando medidas independentes justificarem.",
    "core.ui.pipelines.panels.human_motion.range": "Informe um valor entre {{minimum}} e {{maximum}}.",
    "core.ui.pipelines.panels.human_motion.history": "Idade máxima do histórico (segundos)",
    "core.ui.pipelines.panels.human_motion.score": "Score mínimo do modelo (0–1, não é probabilidade)",
    "core.ui.pipelines.panels.human_motion.frame_age_ms": "Idade máxima do quadro (milissegundos)",
    "core.ui.pipelines.panels.human_motion.gesture_help": "Reconhece uma mão levantada, ambas levantadas, aceno e candidato a apontamento. Usa a orientação do corpo; um candidato bidimensional não é um alvo espacial.",
    "core.ui.pipelines.panels.human_motion.output": "Modo de saída",
    "core.ui.pipelines.panels.human_motion.annotate": "Anotar pacotes da pessoa",
    "core.ui.pipelines.panels.human_motion.events": "Emitir eventos de gesto separados",
    "core.ui.pipelines.panels.human_motion.no_physical_actions": "Nenhuma ação física é habilitada. O modo de eventos substitui a saída de presença por eventos de gesto; use uma ramificação separada para manter ambos.",
    "core.ui.pipelines.panels.human_motion.minimum_duration": "Duração mínima do gesto (segundos)",
    "core.ui.pipelines.panels.human_motion.release": "Espera para encerrar (segundos)",
    "core.ui.pipelines.panels.human_motion.cooldown": "Intervalo entre eventos (segundos)",
    "core.ui.pipelines.panels.human_motion.gap": "Intervalo máximo entre amostras (segundos)",
    ...
    "core.ui.pipelines.operator_name.ptz_attention.request": "Focar PTZ no evento",
    "core.ui.pipelines.operator_description.ptz_attention.request": "Direciona uma câmera PTZ calibrada para um evento mapeado enquanto ele estiver ativo.",
    ...
    "core.ui.pipelines.editor.error.invalid_graph_json": "JSON do grafo inválido: {{error}}",
    "core.ui.pipelines.editor.error.interactive_graph_invalid": "O grafo interativo é inválido.",
    "core.ui.pipelines.editor.error.graph_json_object": "O JSON do grafo precisa ser um objeto.",
    "core.ui.pipelines.editor.error.python_source_required": "O código Python é obrigatório no modo Python.",
    "core.ui.pipelines.editor.error.non_linear_interactive_save_blocked":
    ...
    "core.ui.pipelines.panels.throttle.key.event_id": "ID do subject",
    ...
    "core.ui.pipelines.panels.debounce.key.event_id": "ID do subject",
    ...
    "core.ui.pipelines.storage.confirm_clean": "Limpar todos os arquivos armazenados de '{{name}}'?",
    ...
    "core.ui.pipelines.panels.notify.ephemeral_image": "Imagem ao vivo, sem salvar",
    "core.ui.pipelines.panels.notify.ephemeral_image_hint": "Opcional, apenas em tempo real. Envia a imagem somente ao detalhe da notificação selecionada, com expiração em até 750 ms da publicação na origem. Não fica no histórico e desaparece ao desconectar ou trocar a seleção.",
    ...
    "core.ui.pipelines.panels.notify.payload_paths": "Campos adicionais do payload (opcional)",
    "core.ui.pipelines.panels.notify.payload_paths_placeholder": "Digite o caminho de um campo e pressione Enter",
    "core.ui.pipelines.panels.notify.payload_paths_add": "Incluir {{path}}",
    "core.ui.pipelines.panels.notify.payload_paths_hint": "Até 16 caminhos, como vision.poses; use nomes separados por pontos, sem curingas. Esses campos ficam armazenados com a notificação, mas os pixels das imagens não são gravados. Dados ausentes ou grandes demais aparecem como indisponíveis. Deixe vazio para manter o payload padrão.",
    ...
    "core.ui.pipelines.panels.home_assistant_boolean_state.server": "Servidor Home Assistant",
    "core.ui.pipelines.panels.home_assistant_boolean_state.server_placeholder": "Selecione um servidor…",
    "core.ui.pipelines.panels.home_assistant_boolean_state.server_loading": "Carregando servidores do Home Assistant…",
    "core.ui.pipelines.panels.home_assistant_boolean_state.server_load_failed":
      "Falha ao carregar servidores do Home Assistant: {{error}}",
    "core.ui.pipelines.panels.home_assistant_boolean_state.server_empty":
      "Nenhum servidor Home Assistant configurado. Adicione um em Configurações > Home Assistant primeiro.",
    "core.ui.pipelines.panels.home_assistant_boolean_state.target_mode": "Sinal",
    "core.ui.pipelines.panels.home_assistant_boolean_state.target_mode.managed_state": "Criar binary_sensor",
    "core.ui.pipelines.panels.home_assistant_boolean_state.target_mode.existing_input_boolean": "Usar input_boolean",
    "core.ui.pipelines.panels.home_assistant_boolean_state.managed_name": "Nome",
    "core.ui.pipelines.panels.home_assistant_boolean_state.managed_name_placeholder": "Movimento da garagem",
    "core.ui.pipelines.panels.home_assistant_boolean_state.managed_entity_preview": "{{entity_id}}",
    "core.ui.pipelines.panels.home_assistant_boolean_state.managed_name_required": "Nomeie o sinal do Home Assistant.",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class": "Tipo",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.motion": "Movimento",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.occupancy": "Ocupação",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.presence": "Presença",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.opening": "Abertura",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.problem": "Problema",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.tamper": "Tamper",
    "core.ui.pipelines.panels.home_assistant_boolean_state.device_class.none": "Sem tipo",
    "core.ui.pipelines.panels.home_assistant_boolean_state.existing_entity": "Helper",
    "core.ui.pipelines.panels.home_assistant_boolean_state.existing_entity_placeholder": "Selecionar input_boolean…",
    "core.ui.pipelines.panels.home_assistant_boolean_state.existing_select_server_first": "Selecione um servidor primeiro.",
    "core.ui.pipelines.panels.home_assistant_boolean_state.existing_loading": "Carregando helpers…",
    "core.ui.pipelines.panels.home_assistant_boolean_state.existing_load_failed": "Falha ao carregar helpers: {{error}}",
    "core.ui.pipelines.panels.home_assistant_boolean_state.existing_empty": "Nenhum helper input_boolean encontrado.",
    ...
    "core.ui.pipelines.panels.pose.model_hint": "Escolha um modelo de pose corporal no servidor de processamento selecionado. Adicione detecção de pessoas antes desta etapa; a pose reutiliza essas pessoas sem executar outro detector.",
    "core.ui.pipelines.panels.pose.catalog_loading": "Carregando modelos de pose de {{serverId}}…",
    "core.ui.pipelines.panels.pose.catalog_failed": "Não foi possível verificar os modelos de pose em {{serverId}}. Verifique a conexão e atualize a lista.",
    "core.ui.pipelines.panels.pose.install_hint": "Este modelo ainda não está pronto em {{serverId}}. Instale-o aqui antes de executar este pipeline.",
    "core.ui.pipelines.panels.pose.catalog_empty": "Não há modelos de pose registrados em {{serverId}}. Abra os servidores de processamento para importar um manifest de pose compatível e atualize esta lista.",
    "core.ui.pipelines.panels.pose.select_model": "Selecione um modelo de pose para verificar a disponibilidade e prepará-lo em {{serverId}}.",
    "core.ui.pipelines.panels.pose.model_missing": "O modelo salvo {{model}} não está registrado para pose em {{serverId}}. Selecione outro modelo ou importe seu manifest neste servidor.",
    "core.ui.pipelines.panels.pose.unavailable": "Este modelo não pode executar aqui: {{reason}}. Escolha um modelo compatível ou verifique este servidor de processamento.",
    "core.ui.pipelines.panels.pose.install_started": "A instalação de {{model}} começou em {{serverId}}.",
    "core.ui.pipelines.panels.pose.input_artifact": "Imagem para analisar",
    "core.ui.pipelines.panels.pose.input_automatic": "Imagem atual do pipeline (automático)",
    "core.ui.pipelines.panels.pose.input_hint": "Escolha uma imagem das etapas anteriores. As coordenadas da pose mantêm a relação com a imagem original da câmera após recorte ou redimensionamento.",
    "core.ui.pipelines.panels.pose.max_poses": "Máximo de pessoas por quadro",
    "core.ui.pipelines.panels.pose.max_poses_hint": "1–512 pessoas. Limita a inferência de pose em cada quadro; não cria nem rastreia pessoas.",
    "core.ui.pipelines.panels.pose.max_poses_error": "Informe um número inteiro de 1 a 512 pessoas.",
    "core.ui.pipelines.panels.yolo.model_id_hint":
    ...
    "core.ui.pipelines.panels.yolo.local_build.start": "Baixar e preparar automaticamente",
    ...
    "core.ui.pipelines.panels.yolo.provisioning.catalog_checking": "Verificando disponibilidade do modelo em {{serverId}}…",
    "core.ui.pipelines.panels.yolo.provisioning.catalog_failed": "Não foi possível verificar o modelo em {{serverId}}. Atualize o catálogo para tentar novamente.",
    "core.ui.pipelines.panels.yolo.provisioning.catalog_unavailable": "O catálogo de modelos está indisponível em {{serverId}}. A prontidão não foi verificada.",
    "core.ui.pipelines.panels.yolo.provisioning.catalog_model_missing": "O modelo {{model}} não foi encontrado no catálogo de {{serverId}}. Selecione um modelo listado ou atualize o catálogo.",
    "core.ui.pipelines.panels.yolo.provisioning.catalog_select_model": "Selecione um modelo do catálogo de {{serverId}}.",
    ...
    "core.ui.pipelines.panels.yolo.detect_annotate_only_hint":
      "vision.detect mantém os resultados anexados ao frame. Adicione vision.track quando as próximas etapas precisarem de eventos de objeto estáveis.",
    ...
    "core.ui.processing_servers.status.online": "online",
    "core.ui.processing_servers.status.online_with_errors": "online, com erros no fluxo",
    "core.ui.processing_servers.status.offline": "offline",
    ...
    "core.ui.processing_servers.runtime_issues.badge": "Runtime",
    "core.ui.processing_servers.runtime_issues.summary": "{{count}} problema(s) em nó do runtime",
    "core.ui.processing_servers.runtime_issues.node": "{{pipeline}} / {{node}} falhou {{count}} vez(es)",
    ...
    "core.ui.processing_servers.vision_recommendations.manifest_only": "precisa preparar arquivo do modelo",
    "core.ui.processing_servers.vision_recommendations.needs_model_file": "precisa preparar arquivo do modelo",
    ...
    "core.ui.processing_servers.local_build.unavailable_next_step":
      "Próximo passo: instale Docker ou Podman neste host, escolha um modelo pronto ou prepare/faça upload do modelo manualmente no operador de detecção.",
    "core.ui.processing_servers.local_build.model_unavailable_next_step":
      "Instale Docker ou Podman neste host, escolha um modelo pronto ou prepare/faça upload deste modelo manualmente no operador de detecção.",
    ...
    "core.ui.processing_servers.origin_metrics.item": "{{count}} {{label}}",
    "core.ui.processing_servers.origin_metrics.models_unknown": "{{count}} modelos sem origem registrada",
    "core.ui.processing_servers.origin_metrics.jobs_unknown": "{{count}} jobs sem origem registrada",
    ...
    "core.ui.processing_servers.custom_catalog.availability.manifest_only": "precisa preparar arquivo do modelo",
    ...
    "core.ui.processing_server_modal.connection_runtime_errors": "Conexão: OK, mas há {{count}} problema(s) em nó do runtime",
