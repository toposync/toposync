...
const translationsByLocale: Record<Locale, Translations> = {
  en: {
    ...
    "core.ui.render_modal.option_streams.desc": "Display enabled live camera views in a paged dashboard.",
  ...
  "pt-BR": {
    ...
    "core.ui.render_modal.option_streams.desc": "Exibe visualizações de câmeras ao vivo habilitadas em um dashboard com paginação.",
