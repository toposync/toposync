...
const translationsByLocale: Record<Locale, Translations> = {
  en: {
    ...
    "core.ui.streams.empty": "No live camera views enabled. Create one in Settings > Streams > Live cameras.",
  ...
  "pt-BR": {
    ...
    "core.ui.streams.empty": "Nenhuma câmera ao vivo habilitada. Crie em Configurações > Transmissões > Câmeras ao vivo.",
