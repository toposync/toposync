...
const translationsByLocale: Record<Locale, Translations> = {
  ...
  "pt-BR": {
    ...
    "core.ui.pipelines.panels.publish_video.transmission_hint": "A transmissão selecionada recebe os frames de vídeo desta etapa do pipeline.",
    ...
    "core.ui.vision.huggingface_modal.summary": "Pipeline tag: {{pipelineTag}} • licença declarada: {{license}}",
