...
const translationsByLocale: Record<Locale, Translations> = {
  ...
  "pt-BR": {
    ...
    "core.ui.pipelines.topology.field.blocked_put_ms": "Put bloqueado (ms)",
    "core.ui.pipelines.topology.field.waiting_get_ms": "Get em espera (ms)",
    ...
    "core.ui.pipelines.topology.fallback.needs_v2.title": "Schema de grafo não suportado",
    "core.ui.pipelines.topology.fallback.needs_v2.detail": "Fluxos precisam usar schema_version=2.",
    "core.ui.pipelines.topology.fallback.incomplete.title": "Graph v2 incompleto",
    "core.ui.pipelines.topology.fallback.incomplete.detail": "A visualização de topologia precisa dos arrays de nodes e edges.",
    "core.ui.pipelines.topology.error.requires_v2": "A edição de topologia requer graph schema v2.",
    "core.ui.pipelines.topology.error.node_not_found": "Nó '{{nodeId}}' não encontrado.",
    "core.ui.pipelines.topology.error.edge_not_found": "Edge '{{edgeId}}' não encontrada.",
