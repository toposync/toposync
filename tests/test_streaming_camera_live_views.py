...
from toposync_ext_streaming.api.models import CameraLiveView, StreamingExtensionSettings
                ...
                "devices": [
                    {
                        ...
                        "control": {"type": "none"},
                        "sources": [
                            _camera_source("main", role="main", rtsp_url="rtsp://10.0.0.10/high", is_default=True, ingest=main_ingest),
                            _camera_source("sub", role="sub", rtsp_url="rtsp://10.0.0.10/low"),
                            _camera_source("zoom", role="zoom", rtsp_url="rtsp://10.0.0.10/zoom"),
                        ],
                    }
                ]
            },
